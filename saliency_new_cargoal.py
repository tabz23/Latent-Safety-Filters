...
def load_data(task: str, root: str, seed=42, n_rollout=None, split_ratio=0.9):
    ...
    dset_path = Path(root) / "cargoalnewshort"
    base_dset = Dataset(
        str(dset_path),
...
def main():
    ...
    p.add_argument("--wm_ckpt_root", default="checkpoints/wm/cargoal",
                   help="Root directory of the DINO-WM checkpoints (final dir is <root>/<backbone>)")
    p.add_argument("--hj_ckpt_dir",  default="checkpoints/hj/cargoal",
...
# python saliency_new_cargoal.py --task cargoal --data_path "datasets" --backbone dino --occlusion_method white --blur_sigma 11 --num_samples 20 --output_dir outputs/saliency/cargoal --seed 3 --patch_size 35 --stride 15 --with_proprio
# python saliency_new_cargoal.py --task cargoal --data_path "datasets" --backbone dino_cls --occlusion_method black --blur_sigma 11 --num_samples 20 --output_dir outputs/saliency/cargoal --seed 3 --patch_size 20 --stride 10 --with_proprio




    # python saliency_new_cargoal.py --task cargoal --data_path "datasets" --backbone dino_cls --occlusion_method white --blur_sigma 11 --num_samples 20 --output_dir outputs/saliency/cargoal_seed3 --seed 4 --patch_size 32 --stride 10 --with_proprio